...
<html>
    ...
    <header>
        ...
        <content>
                <div class="Border"> 
                    <h1>Push Up</h1>
                    <div class="left"><img src="Crop/pushup.png" width="250" height="250" style="float: left;"></div>
                    <h4>&emsp;Cara :</h>
                    <p>Letakkan tangan di lantai dengan posisi terbuka selebar bahu Anda. Kaki bertumpu pada ujung jari kaki Anda, hingga tubuh berposisi lurus sempurna. 
                        Jangan ada posisi atau bokong Anda menonjol ke atas. Turunkan bahu Anda sampai membentuk siku 90 derajat. Kemudian dorong bahu dan lengan hingga lurus ke depan dengan sambil mengambil napas.<br><br>
                        Melakukan push-up yang baik dan benar akan mengencangkan otot-otot Anda, terutama pada bagian lengan, dada, dan perut.</p>
                </div>
        </content>
</body>
</html>