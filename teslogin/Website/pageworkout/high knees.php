...
<html>
    ...
    <header>
        ...
        <content>
                <div class="Border"> 
                    <h1>High Knees </h1>
                    <div class="left"><img src="Crop/high knees.png" width="250" height="250" style="float: left;"></div>
                    <h4>&emsp;Cara :</h>
                    <p>Berdirilah dengan kaki selebar pinggul. Angkat lutut kiri ke dada, Kemudian beralih untuk mengangkat lutut kanan ke dada. Lanjutkan gerakan, berganti-ganti kaki dan bergerak dengan kecepatan berlari atau lari di tempat.
                    <br><br> Manfaatnya dapat menurunkan kalori anda dengan cepat, meningkatkan otot kaki dan paha.</p>
                </div>
        </content>
</body>
</html>