...
<html>
    ...
    <header>
        ...
        <content>
                <div class="Border"> 
                    <h1>Jumping Jack</h1>
                    <div class="left"><img src="Crop/Jumping jack.png" width="250" height="250" style="float: left;"></div>
                    <h4>&emsp;Cara :</h>
                    <p>Mulailah berdiri dengan kedua kaki bersatu, sedikit menekuk lutut, dan tangan bertumpu pada paha. Usahakan lutut ditekuk, buka lengan dan kaki ke samping. Lengan datang di atas kepala dan kaki lebih lebar dari bahu. Tutup lengan dan kaki Anda kembali ke samping, kembali ke awal.
                    <br><br> Manfaatnya Dapat megurangi kalori dengan cepat di seluruh tubuh dan membakar lemak tubuh.
                   </p>
                </div>
        </content>
</body>
