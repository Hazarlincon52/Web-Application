...
<html>
    ...
    <header>
        ...
        <content>
                <div class="Border"> 
                    <h1>Bounces</h1>
                    <div class="left"><img src="Crop/bounces.png" width="250" height="250" style="float: left;"></div>
                    <h4>&emsp;Cara :</h>
                    <p>Berdiri dengan posisi tegak. kemudian lanjutkan dengan melompat rendah atau kecil, dan mendarat dengan sikut di berbengkok sedikit, lalukan secara berulang.<br><br> Manfaatnya dapat megurangi kalori yang ada di tubuh, meningkatkan tinggi badan sedikit.</p>
                </div>
        </content>
</body>
</html>